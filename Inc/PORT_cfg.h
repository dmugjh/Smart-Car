...
#define FTM0_CH1_PIN    PTC2//PTA4        //PTC2、PTA4
#define FTM0_CH2_PIN    PTC3//PTA5        //PTC3、PTA5
#define FTM0_CH3_PIN    PTC4//PTA6        //PTC4、PTA6
...
//      模块通道    端口          可选范围              建议
#define FTM1_CH0_PIN    PTA12//脉冲触发测速中断       //PTA8、PTA12、PTB0
#define FTM1_CH1_PIN    PTA13       //PTA9、PTA13、PTB1

//      模块通道    端口          可选范围              建议
#define FTM2_CH0_PIN    PTA10       //PTA10、PTB18
#define FTM2_CH1_PIN    PTB19       //PTA11       //PTA11、PTB19
...
#define I2C1_SCL_PIN    PTE1//PTC10       // PTE1、PTC10
#define I2C1_SDA_PIN    PTE0//PTC11       // PTE0、PTC11
...
#define CAN1_TX_PIN     PTC17       //PTE24、PTC17              全部都是 ALT2
#define CAN1_RX_PIN     PTC16       //PTE25、PTC16              全部都是 ALT2
