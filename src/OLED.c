...
//        l = (data%10000)/1000;
	...
	j = (data%100)/10;
	k = data%10;
//        LED_P6x8Char(x+6,y,t+48);
//        LED_P6x8Char(x+12,y,l+48);
	if(i!=0) LED_P6x8Char(x+6,y,i+48);  else LED_P6x8Char(x+6,y,' ');
	if(j!=0 ||(j==0&&i!=0)) LED_P6x8Char(x+12,y,j+48); else LED_P6x8Char(x+12,y,' ');
	LED_P6x8Char(x+18,y,k+48);		
}

 void LED_PrintValueFP(byte x, byte y, word data, byte num)
 {
 	byte m,i,j,k;  	
 	LED_P6x8Char(x, y, '.');
	m= data/1000;
