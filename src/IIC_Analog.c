...
/**************************实现函数********************************************
*函数原型:		void IIC_Send_Byte(uint8 txd)
*功　　能:	    IIC发送一个字节
*******************************************************************************/		  
...
/**************************实现函数********************************************
*函数原型:		uint8 IIC_Read_Byte(unsigned char ack)
...
/**************************实现函数********************************************
*函数原型:		uint8 IICreadBytes(uint8 dev, uint8 reg, uint8 length, uint8 *data)
...
/**************************实现函数********************************************
*函数原型:		uint8 IICwriteBytes(uint8 dev, uint8 reg, uint8 length, uint8* data)
...
/**************************实现函数********************************************
*函数原型:		uint8 IICreadByte(uint8 dev, uint8 reg, uint8 *data)
*功　　能:	    读取指定设备 指定寄存器的一个值
输入	dev  目标设备地址
		reg	   寄存器地址
		*data  读出的数据将要存放的地址
...
/**************************实现函数********************************************
*函数原型:		uint8 IICwriteBits(uint8 dev,uint8 reg,uint8 bitStart,uint8 length,uint8 data)
...
/**************************实现函数********************************************
*函数原型:		uint8 IICwriteBit(uint8 dev, uint8 reg, uint8 bitNum, uint8 data)
